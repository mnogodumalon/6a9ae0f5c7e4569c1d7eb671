  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'assigned_agent': (
      <div key="assigned_agent" className="space-y-1.5">
        ...
        <Combobox
          id="assigned_agent"
          placeholder="Mitarbeitende/r zuweisen"
    ...
    'parent_ticket': (
      <div key="parent_ticket" className="space-y-1.5">
        ...
        <Combobox
          ...
          onCreateNew={(q) => openCreateTickets("parent_ticket", q)}
    ...
    'title': (
      <div key="title" className="space-y-1.5">
        ...
        <Input
          id="title"
          placeholder="z. B. Drucker im 2. OG offline"
          value={fields.title ?? ''}
    ...
    'description': (
      <div key="description" className="space-y-1.5">
        ...
        <Textarea
          id="description"
          placeholder="Problem-Details, Schritte zum Reproduzieren..."
    ...
    'affected_asset': (
      <div key="affected_asset" className="space-y-1.5">
        ...
        <Combobox
          id="affected_asset"
          placeholder="Betroffenes Asset wählen"
    ...
    'vendor_link': (
      <div key="vendor_link" className="space-y-1.5">
        ...
        <Input
          ...
          type="url"
          inputMode="url"
          placeholder="z. B. https://support.dell.com/..."
    ...
    'resolution': (
      <div key="resolution" className="space-y-1.5">
        ...
        <Textarea
          id="resolution"
          placeholder="Gelöste Schritte, Ergebnis..."
    ...
    'internal_note': (
      <div key="internal_note" className="space-y-1.5">
        ...
        <Textarea
          id="internal_note"
          placeholder="Interne Anmerkungen, Erfahrungen..."
