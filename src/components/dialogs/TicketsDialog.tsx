  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'title': (
      <div key="title" className="space-y-1.5">
        ...
        <Input
          id="title"
          placeholder="z. B. VPN-Zugang funktioniert nicht"
          value={fields.title ?? ''}
    ...
    'description': (
      <div key="description" className="space-y-1.5">
        ...
        <Textarea
          id="description"
          placeholder="Detaillierte Problembeschreibung eingeben"
    ...
    'reporter_email': (
      <div key="reporter_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. m.mustermann@example.com"
    ...
    'opened_on': (
      <div key="opened_on" className="space-y-1.5">
        ...
        <DatePicker
          id="opened_on"
          placeholder="Heute oder späteres Datum?"
          mode="date"
    ...
    'affected_asset': (
      <div key="affected_asset" className="space-y-1.5">
        ...
        <Combobox
          id="affected_asset"
          placeholder="Welches Gerät betroffen?"
    ...
    'vendor_link': (
      <div key="vendor_link" className="space-y-1.5">
        ...
        <Input
          ...
          type="url"
          inputMode="url"
          placeholder="z. B. https://support.vendor.com/ticket"
    ...
    'internal_note': (
      <div key="internal_note" className="space-y-1.5">
        ...
        <Textarea
          id="internal_note"
          placeholder="Team-Notizen, nicht sichtbar außen"
