  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'parent_ticket': (
      <div key="parent_ticket" className="space-y-1.5">
        ...
        <Combobox
          id="parent_ticket"
          placeholder="Übergeordnet? Optional"
    ...
    'description': (
      <div key="description" className="space-y-1.5">
        ...
        <Textarea
          id="description"
          placeholder="Was ist das Problem? Schritte zum Reproduzieren, Fehlermeldungen..."
    ...
    'affected_asset': (
      <div key="affected_asset" className="space-y-1.5">
        ...
        <Combobox
          id="affected_asset"
          placeholder="Betroffenes Gerät wählen"
    ...
    'resolution': (
      <div key="resolution" className="space-y-1.5">
        ...
        <Textarea
          id="resolution"
          placeholder="Lösung beschreiben"
    ...
    'internal_note': (
      <div key="internal_note" className="space-y-1.5">
        ...
        <Textarea
          id="internal_note"
          placeholder="Interne Hinweise, Log-Auszüge, Notizen..."
