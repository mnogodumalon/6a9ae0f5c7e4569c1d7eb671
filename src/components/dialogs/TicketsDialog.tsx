  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'assigned_agent': (
      <div key="assigned_agent" className="space-y-1.5">
        ...
        <Combobox
          id="assigned_agent"
          placeholder="Zuständige/r Mitarbeitende/r"
    ...
    'team': (
      <div key="team" className="space-y-1.5">
        ...
        <Combobox
          id="team"
          placeholder="Welches Team bearbeitet?"
    ...
    'parent_ticket': (
      <div key="parent_ticket" className="space-y-1.5">
        ...
        <Combobox
          id="parent_ticket"
          placeholder="Übergeordnetes Ticket"
    ...
    'title': (
      <div key="title" className="space-y-1.5">
        ...
        <Input
          id="title"
          placeholder="z. B. Drucker reagiert nicht"
          value={fields.title ?? ''}
    ...
    'opened_on': (
      <div key="opened_on" className="space-y-1.5">
        ...
        <DatePicker
          id="opened_on"
          placeholder="Wann wurde eröffnet?"
          mode="date"
    ...
    'vendor_link': (
      <div key="vendor_link" className="space-y-1.5">
        ...
        <Input
          ...
          type="url"
          inputMode="url"
          placeholder="z. B. https://support.vendor.com"
    ...
    'internal_note': (
      <div key="internal_note" className="space-y-1.5">
        ...
        <Textarea
          id="internal_note"
          placeholder="Interne Notizen für Team"
