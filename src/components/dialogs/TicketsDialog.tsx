  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'assigned_agent': (
      <div key="assigned_agent" className="space-y-1.5">
        ...
        <Combobox
          id="assigned_agent"
          placeholder="Wer bearbeitet das Ticket?"
    ...
    'team': (
      <div key="team" className="space-y-1.5">
        ...
        <Combobox
          id="team"
          placeholder="Welches Team ist verantwortlich?"
    ...
    'description': (
      <div key="description" className="space-y-1.5">
        ...
        <Textarea
          id="description"
          placeholder="Problembeschreibung, Fehlertext, Reproduktionsschritte..."
    ...
    'due': (
      <div key="due" className="space-y-1.5">
        ...
        <DatePicker
          id="due"
          placeholder="Bis wann soll es gelöst sein?"
          mode="datetime"
    ...
    'affected_asset': (
      <div key="affected_asset" className="space-y-1.5">
        ...
        <Combobox
          id="affected_asset"
          placeholder="Welches Gerät ist betroffen?"
    ...
    'internal_note': (
      <div key="internal_note" className="space-y-1.5">
        ...
        <Textarea
          id="internal_note"
          placeholder="Nur für Ihren Austausch im Team..."
