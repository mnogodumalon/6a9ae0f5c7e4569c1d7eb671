  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'assigned_agent': (
      <div key="assigned_agent" className="space-y-1.5">
        ...
        <Combobox
          id="assigned_agent"
          placeholder="Mitarbeitende/r wählen"
    ...
    'description': (
      <div key="description" className="space-y-1.5">
        ...
        <Textarea
          id="description"
          placeholder="Ausführliche Problembeschreibung, Fehlermeldungen, betroffene Nutzer..."
    ...
    'due': (
      <div key="due" className="space-y-1.5">
        ...
        <DatePicker
          id="due"
          placeholder="Wann muss es gelöst sein?"
          mode="datetime"
    ...
    'opened_on': (
      <div key="opened_on" className="space-y-1.5">
        ...
        <DatePicker
          id="opened_on"
          placeholder="Wann wurde das Ticket eröffnet?"
          mode="date"
    ...
    'vendor_link': (
      <div key="vendor_link" className="space-y-1.5">
        ...
        <Input
          ...
          type="url"
          inputMode="url"
          placeholder="z. B. https://support.vendor.com/ticket123"
    ...
    'internal_note': (
      <div key="internal_note" className="space-y-1.5">
        ...
        <Textarea
          id="internal_note"
          placeholder="Interne Anmerkungen, nicht sichtbar für Meldende..."
