...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "IT Helpdesk",
    "apps": {
      "assets": {
        "name": "Assets",
        "app_id": "6a9ae0d76f2d860dd77584a8",
        "fields": {
          "name": "Name",
          "serial_number": "Seriennummer",
          "location": "Standort",
          "purchased_on": "Angeschafft am",
      ...
      "teams": {
        "name": "Teams",
        "app_id": "6a9ae0dc1f2e1b30f627183a",
        "fields": {
          "lead": "Teamleitung",
          "name": "Name",
      ...
      "mitarbeitende": {
        "name": "Mitarbeitende",
        "app_id": "6a9ae0dc8d9785c8b900f7db",
        "fields": {
          "first_name": "Vorname",
          "last_name": "Nachname",
          "email": "E-Mail",
      ...
      "tickets": {
        "name": "Tickets",
        "app_id": "6a9ae0ddcc338e60e69048d0",
        "fields": {
          "assigned_agent": "Zugewiesene/r Mitarbeitende/r",
          "team": "Team",
          ...
          "reporter_email": "E-Mail der meldenden Person",
          "reporter_phone": "Telefon der meldenden Person",
          "due": "Fällig am",
          "opened_on": "Eröffnet am",
          "tags": "Tags",
          "affected_asset": "Betroffenes Asset",
          "vendor_link": "Lieferanten-Link",
      ...
      "notizen": {
        "name": "Notizen",
        "app_id": "6a9ae0ddb7e5e83aa30808fc",
        "fields": {
          "ticket": "Ticket",
          "text": "Text",
          "author": "Verfasser/in",
          "visible_to_reporter": "Für meldende Person sichtbar"
        },
        "lookups": {}
      }
    }
  ...
  "en": {
    ...
    "apps": {
      ...
      "tickets": {
        ...
        "app_id": "6a9ae0ddcc338e60e69048d0",
        "fields": {
          "assigned_agent": "Assigned Employee",
          "team": "Team",
      ...
      "notizen": {
        ...
        "fields": {
          ...
          "text": "Text",
          "author": "Author",
          "visible_to_reporter": "Visible to Reporter"
        },
        "lookups": {}
      }
    }
