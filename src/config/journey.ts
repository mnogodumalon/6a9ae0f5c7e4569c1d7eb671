 ...
 *   - assets: no date pair, no references
 *   - teams: applookups lead→mitarbeitende
 *   - mitarbeitende: applookups team→teams
 *   - tickets: applookups assigned_agent→mitarbeitende, team→teams, parent_ticket→tickets, affected_asset→assets · lookups priority[low|medium|high|critical], status[closed|new|in_progress|waiting_for_customer|resolved], category[hardware|software|network|access|printing|phone|other], customer_satisfaction[option_1|option_2|option_3|option_4|option_5]
 *   - notizen: applookups ticket→tickets
 */
