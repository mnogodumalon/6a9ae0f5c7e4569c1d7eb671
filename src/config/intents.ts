...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neues-ticket', label: { de: 'Neues Ticket', en: 'New ticket' }, icon: IconTicket, description: 'Neues Support-Ticket in 3 Schritten eröffnen' },
  { path: '/intents/ticket-zuweisen', label: { de: 'Ticket zuweisen', en: 'Assign ticket' }, icon: IconUserCheck, description: 'Ticket einem aktiven Mitarbeiter und Team zuweisen' },
  { path: '/intents/notiz-hinzufuegen', label: { de: 'Notiz hinzufügen', en: 'Add note' }, icon: IconNotes, description: 'Interne oder externe Notiz zu einem Ticket hinzufügen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T09:53:23+00:00';
