...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neues-ticket', label: { de: 'Neues Ticket', en: 'New ticket' }, icon: IconTicket, description: 'Ticket in 3 Schritten eröffnen: Meldung, Priorität und Asset' },
  { path: '/intents/ticket-zuweisen', label: { de: 'Ticket zuweisen', en: 'Assign ticket' }, icon: IconUserCheck, description: 'Ticket einem aktiven Agenten zuweisen oder neu zuweisen' },
  { path: '/intents/notiz-hinzufuegen', label: { de: 'Notiz hinzufügen', en: 'Add note' }, icon: IconNotes, description: 'Interne Notiz oder Kundenantwort zu einem Ticket hinzufügen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T12:55:16+00:00';
