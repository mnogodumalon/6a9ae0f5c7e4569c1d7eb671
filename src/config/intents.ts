...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neues-ticket', label: { de: 'Neues Ticket', en: 'New ticket' }, icon: IconTicket, description: 'Ticket in 3 Schritten eröffnen: Meldung, Klassifizierung, Bestätigung' },
  ...
  { path: '/intents/notiz-hinzufuegen', label: { de: 'Notiz hinzufügen', en: 'Add note' }, icon: IconNote, description: 'Interne Notiz oder Kundennotiz zu einem Ticket hinzufügen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T14:48:24+00:00';
