...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/ticket-zuweisen', label: { de: 'Ticket zuweisen', en: 'Assign ticket' }, icon: IconUserCheck, description: 'Ticket einem aktiven Agenten und Team zuweisen oder neu zuweisen' },
  { path: '/intents/notiz-hinzufuegen', label: { de: 'Notiz hinzufügen', en: 'Add note' }, icon: IconNotes, description: 'Interne oder für den Reporter sichtbare Notiz zu einem Ticket hinzufügen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-04T15:51:05+00:00';
