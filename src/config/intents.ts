...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neues-ticket', label: { de: 'Neues Ticket', en: 'New ticket' }, icon: IconTicket, description: 'Ticket in 3 Schritten mit Reporter, Priorität und optionalem Asset anlegen' },
  { path: '/intents/ticket-zuweisen', label: { de: 'Ticket zuweisen', en: 'Assign ticket' }, icon: IconUserCheck, description: 'Ticket einem aktiven Agenten und einem Team zuweisen oder neu zuweisen' },
  { path: '/intents/notiz-hinzufuegen', label: { de: 'Notiz hinzufügen', en: 'Add note' }, icon: IconNotes, description: 'Interne oder externe Notiz zu einem Ticket erfassen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T11:36:42+00:00';
