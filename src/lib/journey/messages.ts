...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  teams: { name: "Bitte den Team-Namen eingeben." },
  ...
  tickets: { title: "Bitte einen Titel für das Ticket eingeben.", priority: "Bitte eine Priorität wählen.", status: "Bitte einen Status wählen.", reporter_name: "Bitte den Namen der meldenden Person eingeben.", reporter_email: "Bitte die E-Mail der meldenden Person eingeben.", due: "Bitte ein Fälligkeitsdatum wählen.", opened_on: "Bitte das Eröffnungsdatum angeben.", estimated_hours: "Bitte die geschätzte Stundenzahl eingeben." },
  // </custom:messages>
};
