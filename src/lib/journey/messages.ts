...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  // <custom:messages>
  tickets: { title: "Bitte einen Titel für das Ticket eingeben.", priority: "Bitte eine Priorität auswählen.", status: "Bitte einen Status auswählen.", reporter_name: "Bitte den Namen der meldenden Person eingeben.", reporter_email: "Bitte die E-Mail-Adresse der meldenden Person eingeben.", due: "Bitte ein Fälligkeitsdatum und eine Uhrzeit wählen.", opened_on: "Bitte das Eröffnungsdatum eingeben.", estimated_hours: "Bitte die geschätzten Stunden angeben." },
  ...
  teams: { name: "Bitte einen Teamnamen eingeben." },
