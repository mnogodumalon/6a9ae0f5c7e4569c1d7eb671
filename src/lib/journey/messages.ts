...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  tickets: { title: "Bitte einen Titel für das Ticket eingeben.", priority: "Bitte eine Priorität wählen.", status: "Bitte einen Status wählen.", reporter_name: "Bitte den Namen der meldenden Person eingeben.", reporter_email: "Bitte die E-Mail der meldenden Person eingeben.", due: "Bitte das Fälligkeitsdatum wählen.", opened_on: "Bitte das Eröffnungsdatum wählen.", estimated_hours: "Bitte die geschätzten Stunden eingeben." },
  // </custom:messages>
};
