...
### `assets` — Assets (type `Assets`, one record: `Asset`)
Display fields: `name`
- `name` · text · Name · required! · maxLength 4000
- `serial_number` · text · Seriennummer · required! · maxLength 4000
- `location` · geo · Standort
- `purchased_on` · date · Angeschafft am
- `warranty_until` · date · Garantie bis

### `teams` — Teams (type `Teams`, one record: `Team`)
Display fields: `name`
- `lead` · record · Teamleitung · → `mitarbeitende`
- `name` · text · Name · required! · maxLength 4000
- `cost_center` · text · Kostenstelle · maxLength 4000

### `mitarbeitende` — Mitarbeitende (type `Mitarbeitende`, one record: `MitarbeitendeEntry`)
Display fields: `first_name`, `last_name`
- `first_name` · text · Vorname · required! · maxLength 4000
- `last_name` · text · Nachname · required! · maxLength 4000
- `email` · email · E-Mail · required!
- `phone` · tel · Telefon
- `active` · bool · Aktiv
- `working_hours_per_week` · number · Arbeitsstunden pro Woche
- `team` · record · Team · → `teams`

### `tickets` — Tickets (type `Tickets`, one record: `Ticket`)
Display fields: `title`
- `assigned_agent` · record · Zugewiesene/r Mitarbeitende/r · → `mitarbeitende`
- `team` · record · Team · → `teams`
- `parent_ticket` · record · Übergeordnetes Ticket · → `tickets`
- `title` · text · Titel · required! · maxLength 4000
- `description` · textarea · Beschreibung
- `priority` · lookup · Priorität · required! · options: low | medium | high | critical
- `status` · lookup · Status · required! · options: closed | new | in_progress | waiting_for_customer | resolved
- `category` · lookup · Kategorie · options: hardware | software | network | access | printing | phone | other
- `reporter_name` · text · Name der meldenden Person · required! · maxLength 4000
- `reporter_email` · email · E-Mail der meldenden Person · required!
- `reporter_phone` · tel · Telefon der meldenden Person
- `due` · datetime · Fällig am · required!
- `opened_on` · date · Eröffnet am · required!
- `tags` · multilookup · Tags · options: vip | recurring | security | vendor
- `affected_asset` · record · Betroffenes Asset · → `assets`
- `vendor_link` · url · Lieferanten-Link
- `estimated_hours` · number · Geschätzte Stunden · required!
- `billable` · bool · Abrechenbar
- `resolution` · textarea · Lösung
- `sla_breached` · bool · SLA verletzt
- `customer_satisfaction` · lookup · Kundenzufriedenheit · options: option_1 | option_2 | option_3 | option_4 | option_5
- `attachment` · file · Anhang · read-only
- `internal_note` · textarea · Interne Notiz
Input shapes: choice `priority` (ChoiceGroup); choice `status` (ChoiceGroup); choice `customer_satisfaction` (ChoiceGroup)

### `notizen` — Notizen (type `Notizen`, one record: `NotizenEntry`)
Display fields: `author`
- `ticket` · record · Ticket · → `tickets`
- `text` · textarea · Text
- `author` · text · Verfasser/in · maxLength 4000
- `visible_to_reporter` · bool · Für meldende Person sichtbar
